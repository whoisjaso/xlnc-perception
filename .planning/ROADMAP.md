...
Plans:
- [x] 06-01-PLAN.md - Wire Dashboard Overview to Real Data
- [x] 06-02-PLAN.md - Real-time Call Events via WebSocket
- [x] 06-03-PLAN.md - Per-Client Filtering & Time Range Filters
